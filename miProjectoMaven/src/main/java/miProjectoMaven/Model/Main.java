...
public static Partido cargarPartidos(Equipo equipo1, Equipo equipo2, String[] arrayResultado){//metodo cargar partidos
 ...
 //metodo cargar personas de Base de datos
 public static ArrayList<Persona> cargarPersonas() throws ClassNotFoundException{
		...
		ArrayList<Persona> arrayPersona = new ArrayList<>();
			...
			while(resultado.next()) {	
				Persona persona = new Persona(Integer.parseInt(resultado.getString(1)),resultado.getString(2));
